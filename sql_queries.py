...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, \
                        start_time varchar NOT NULL, user_id int NOT NULL, level varchar NOT NULL, \
                        song_id varchar, artist_id varchar, session_id int NOT NULL, \
                        location varchar, user_agent varchar);")

user_table_create = ("CREATE TABLE IF NOT EXISTS users (user_id int PRIMARY KEY, \
                    first_name varchar NOT NULL, last_name varchar NOT NULL, gender varchar, \
...
user_table_insert = ("INSERT INTO users (user_id, first_name, last_name, gender, level) \
                    ...
                    SET level = EXCLUDED.level WHERE EXCLUDED.level = 'paid'")
